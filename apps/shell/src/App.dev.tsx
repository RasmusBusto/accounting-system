...
// In dev mode, import MFEs directly (no module federation)
// This allows for proper HMR across all apps
import Dashboard from '../../dashboard/src/App';
import Invoicing from '../../invoicing/src/App';
import Expenses from '../../expenses/src/App';
import Reports from '../../reports/src/App';
import Clients from '../../clients/src/App';
import Settings from '../../settings/src/App';
